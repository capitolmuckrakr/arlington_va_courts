...
su ubuntu bash -c "source /home/ubuntu/.profile; source activate basicscraper; python3 -m pip install selenium pyvirtualdisplay psycopg2-binary sqlalchemy; cd /home/ubuntu/scripts; git clone $code_url"
